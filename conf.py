...
BLOG_AUTHOR = "John Mille"  # (translatable)
BLOG_TITLE = "Lambda my AWS"  # (translatable)
...
BLOG_EMAIL = "john@lambda-my-aws.io"
BLOG_DESCRIPTION = "https://github.com/lambda-my-aws/"  # (translatable)
...
# )
POSTS = (
    ("posts/*.rst", "posts", "page.tmpl"),
    ("posts/*.md", "posts", "page.tmpl"),
    ("posts/*.txt", "posts", "page.tmpl"),
    ("posts/*.html", "posts", "page.tmpl"),
)
PAGES = (
